...
public class AppWebMvcConfig implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        registry.addInterceptor(loginInterceptor).addPathPatterns("/**").excludePathPatterns("/login", "/createKaptcha", "/createKaptchaImg", "/cc/**", "/sysConf/loadPic", "/sysUser/loadPic", "/carousel/loadPic", "/artice/loadPic", "/lesson/loadPic", "/doctor/loadPic");
